...
local function resolveWorldHost(host)
  if host and host ~= '' and host ~= '127.0.0.1' and host ~= 'localhost' then
    return host
  end
  if G.host then
...
local function tryLogin(charInfo, tries)
  ...
  CharacterList.hide()
  charInfo.worldHost = resolveWorldHost(charInfo.worldHost)
...
function CharacterList.create(characters, account, otui)
  ...
  for i,characterInfo in ipairs(characters) do
    ...
    widget.worldHost = resolveWorldHost(characterInfo.worldIp)
