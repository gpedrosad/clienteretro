...
function setOption(key, value, force)
  ...
  elseif key == 'musicSoundVolume' then
    ...
    local label = audioPanel and audioPanel:getChildById('musicSoundVolumeLabel')
    if label then
  ...
  elseif key == 'botSoundVolume' then
    ...
    local label = audioPanel and audioPanel:getChildById('botSoundVolumeLabel')
    if label then
      label:setText(tr('Bot sound volume: %d', value))
    end
