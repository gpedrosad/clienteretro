...
SpellInfo = {
  ['Default'] = {
    ...
    ['Light Magic Missile'] =      {id = 7,   words = 'adori',         exhaustion = 2000,  premium = false, type = 'Conjure', icon = 'lightmagicmissile',      mana = 120,    level = 15, soul = 1, group = {[3] = 2000},               vocations = {1, 2, 5, 6}},
    ...
    ['Great Fireball'] =           {id = 16,  words = 'adori gran flam',        exhaustion = 2000,  premium = false, type = 'Conjure', icon = 'greatfireball',          mana = 530,    level = 30, soul = 3, group = {[3] = 2000},               vocations = {1, 5}},
    ['Heavy Magic Missile'] =      {id = 8,   words = 'adori gran',             exhaustion = 2000,  premium = false, type = 'Conjure', icon = 'heavymagicmissile',      mana = 350,    level = 25, soul = 2, group = {[3] = 2000},               vocations = {1, 5, 2, 6}},
    ...
    ['Sudden Death'] =             {id = 21,  words = 'adori vita vis',       exhaustion = 2000,  premium = false, type = 'Conjure', icon = 'suddendeath',            mana = 985,    level = 45, soul = 5, group = {[3] = 2000},               vocations = {1, 5}},
    ...
    ['Paralyze'] =                 {id = 54,  words = 'utani slow',             exhaustion = 2000,  premium = false, type = 'Conjure', icon = 'paralyze',               mana = 1400,   level = 54, soul = 3, group = {[3] = 2000},               vocations = {2, 6}},
  ...
  -- [Retro76] Palabras propias del server 7.6 ausentes en 'Default'. Solo para que
  -- getSpellByWords las reconozca (texto naranja). NO se muestran en el spell list
  -- (usa 'Default'); icon dummy para no colisionar con getSpellByIcon.
  ['Retro76'] = {
    ['Blank'] =                    {id = 2001, words = 'adori blank',          exhaustion = 2000,  premium = false, type = 'Conjure', icon = 'retro_blank',           mana = 60,     level = 3,  soul = 0, group = {[3] = 2000},               vocations = {1, 2, 3, 5, 6, 7}},
    ['Death Spell'] =              {id = 2002, words = 'death',                exhaustion = 2000,  premium = false, type = 'Instant', icon = 'retro_death',           mana = 1,      level = 1,  soul = 0, group = {[1] = 2000},               vocations = {1, 2, 3, 4, 5, 6, 7, 8}},
  }--[[,
